        ...
        <div className="px-8 pb-8">
          ...
          <div className="mt-10 flex justify-between">
            ...
            <button
              ...
              } flex items-center justify-center rounded-full bg-blue-500 px-3.5 py-1.5 font-medium tracking-tight text-white hover:bg-blue-600 active:bg-blue-700`}
            >
              Continue
            </button>
          </div>
...
function Step({ step, currentStep }: { step: number; currentStep: number }) {
  ...
  return (
    <motion.div animate={status} className="relative">
      <motion.div
        variants={{
          active: { scale: 1, transition: { duration: 0.2, delay: 0 } },
          complete: { scale: 1.25 },
        }}
        transition={{
          duration: 0.4,
